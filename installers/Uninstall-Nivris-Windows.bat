...
rem Cung co che bootstrap Node nhu ban Install: may khong co Node thi tai ban portable ve thu
rem muc tam, de nguoi da cai duoc bang file nay thi cung go duoc bang file nay.
set "NODEDIR=%TEMP%\nivris-node"
...
if %STATUS%==0 (
    ...
    echo Go cai dat gap loi ^(xem chi tiet o tren^). Neu can, mo Command Prompt bang
